...
export default function LocaleNotFound() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <p className="text-6xl font-bold text-[--color-brand-deep]">404</p>
      ...
      <Link
        href="/"
        className="mt-8 inline-flex rounded-lg bg-[--color-brand-deep] px-6 py-3 text-sm font-semibold text-white transition-opacity hover:opacity-90"
      >
        Go home
      </Link>
    </div>
